      ...
      <div>
        <div className="banner">
          <span className="banner-title">
            <span>Ferquently Asked Questions</span>
            <h1>FAQ</h1>
          </span>
        </div>
        <>
          ...
          <p>
            ...
            stress disorder. Untreated, anxiety disorders can lead to
            significant impairment on people’s daily lives.
            <br />
            <br />
          ...
          <h3>2. Behavioural and emotional disorders in children</h3>
          <p>
            Common behaviour disorders in children include oppositional defiant
            disorder (ODD), conduct disorder (CD) and attention deficit
            hyperactivity disorder (ADHD). Treatment for these mental health
            disorders can include therapy, education and medication.
            <br />
            <br />
            For more information see:{" "}
          ...
          <h3>3. Bipolar affective disorder</h3>
          <p>
          ...
          <h3>5. Dissociation and dissociative disorders</h3>
          <p>
            ...
            fugue, depersonalisation disorder and dissociative identity
            disorder.
            <br />
            <br />
            For more information see:{" "}
          ...
          <h3>6. Eating disorders s</h3>
          <p>
            Eating disorders include anorexia, bulimia nervosa and other binge
            eating disorders. Eating disorders affect females and males and can
          ...
          <h3>7. Obsessive compulsive disorder (OCD)</h3>
          <p>
            Anxiety disorders is a group of mental health disorders that
            includes generalised anxiety disorders, social phobias, specific
            phobias (for example, agoraphobia and claustrophobia), panic
          ...
          <h3>8. Paranoia</h3>
          <p>
            Paranoia is the irrational and persistent feeling that people are
            ‘out to get you’. Paranoia may be a symptom of conditions including
            paranoid personality disorder, delusional (paranoid) disorder and
            schizophrenia. Treatment for paranoiainclude medications and
          ...
          <h3>9. Post-traumatic stress disorder (PTSD)</h3>
          <p>
            Post-traumatic stress disorder (PTSD) is a mental health condition
            that can develop as a response to people who have experienced any
            traumatic event. This can be a car or other serious accident,
            physical or sexual assault, war-related events or torture, or
          ...
          <p>
            ...
            reality. Symptoms of schizophrenia vary widely but may include
            hallucinations, delusions, thought disorder, social withdrawal, lack
            of motivation and impaired thinking and memory. People with
            schizophrenia have a high risk of suicide. Schizophrenia is not a
            split personality.
            <br />
            <br />
            For more information see:{" "}
          ...
          <h3>
            12. Stress response syndromes (formerly called adjustment disorders)
          </h3>
          <p>
            Stress response syndromes occur when a person develops emotional or
            behavioral symptoms in response to a stressful event or situation.
            The stressors may include natural disasters, such as an earthquake
            or tornado; events or crises, such as a car accident or the
            diagnosis of a major illness; or interpersonal problems, such as a
            divorce, death of a loved one, loss of a job, or a problem with
            substance abuse. Stress response syndromes usually begin within
            three months of the event or situation and ends within six months
            after the stressor stops or is eliminated.
            <br />
            <br />
            For more information see:{" "}
          ...
          <h3>12. Personality disorders</h3>
          <p>
            ...
            histrionic personality disorder, schizoid personality disorder, and
            paranoid personality disorder.
            <br />
            <br />
            For more information see:{" "}
            <a href="https://www.google.com/">Personality disorders</a>
          </p>

          <h3>13. Factitious disorders</h3>
          <p>
            Factitious disorders are conditions in which a person knowingly and
            intentionally creates or complains of physical and/or emotional
            symptoms in order to place the individual in the role of a patient
            or a person in need of help.
            <br />
            <br />
            For more information see:{" "}
            <a href="https://www.google.com/">Factitious disorders</a>
          </p>
          <h3>14. Sexual and gender disorders</h3>
          <p>
            These include disorders that affect sexual desire, performance, and
            behavior. Sexual dysfunction, gender identity disorder, and the
            paraphilias are examples of sexual and gender disorders.
            <br />
            <br />
            For more information see:{" "}
            <a href="https://www.google.com/">Sexual and gender disorders</a>
          </p>
          <h3>15. Somatic symptom disorders</h3>
          <p>
            A person with a somatic symptom disorder, formerly known as a
            psychosomatic disorder or somatoform disorder, experiences physical
            symptoms of an illness or of pain with an excessive and
            disproportionate level of distress, regardless of whether or not a
            doctor can find a medical cause for the symptoms.
            <br />
            <br />
            For more information see:{" "}
          ...
          <h3>16. Tic disorders</h3>
          <p>
            People with tic disorders make sounds or display nonpurposeful body
            movements that are repeated, quick, sudden, and/or uncontrollable.
            (Sounds that are made involuntarily are called vocal tics.)
            Tourette's syndrome is an example of a tic disorder.
            <br />
            <br />
            For more information see:{" "}
            <a href="https://www.webmd.com/brain/tourettes-syndrome">Tic disorders</a>
          </p>
          </div>
        </div> */}
        </>
            ...
            <div className="tabs">
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    Anxiety disorders is a group of mental health disorders that
                    includes generalised anxiety disorders, social phobias,
                    specific phobias (for example, agoraphobia and
                    claustrophobia), panic disorders, obsessive compulsive
                    disorder (OCD) and post-traumatic stress disorder.
                    Untreated, anxiety disorders can lead to significant
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    Depression is a mood disorder characterised by lowering of
                    mood, loss of interest and enjoyment, and reduced energy. It
                    is not just feeling sad. There are different types and
                    symptoms of depression. There are varying levels of severity
                    and symptoms related to depression. Symptoms of depression
                    can lead to increased risk of suicidal thoughts or
                    behaviours.
                    <br />
                    <br />
                    For more information see:{" "}
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    Dissociation is a mental process where a person disconnects
                    from their thoughts, feelings, memories or sense of
                    identity. Dissociative disorders include dissociative
                    amnesia, dissociative fugue, depersonalisation disorder and
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    Paranoia is the irrational and persistent feeling that
                    people are ‘out to get you’. Paranoia may be a symptom of
                    conditions including paranoid personality disorder,
                    delusional (paranoid) disorder and schizophrenia. Treatment
                    for paranoiainclude medications and psychological support.
                    <br />
                    <br />
                    For more information see:{" "}
                    <a href="https://www.betterhealth.vic.gov.au/health/conditionsandtreatments/paranoia">
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    ...
                    serious accident, physical or sexual assault, war-related
                    events or torture, or natural disasters such as bushfires or
                    floods.
                    <br />
                    <br />
                    For more information see:{" "}
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    People affected by psychosis can experience delusions,
                    hallucinations and confused thinking.. Psychosis can occur
                    in a number of mental illnesses, including drug-induced
                    psychosis, schizophrenia and mood disorders. Medication and
                    psychological support can relieve, or even eliminate,
                    psychotic symptoms.
                    <br />
                    <br />
                    For more information see:{" "}
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    Schizophrenia is a complex psychotic disorder characterised
                    by disruptions to thinking and emotions, and a distorted
                    perception of reality. Symptoms of schizophrenia vary widely
                    but may include hallucinations, delusions, thought disorder,
                    social withdrawal, lack of motivation and impaired thinking
                    and memory. People with schizophrenia have a high risk of
                    suicide. Schizophrenia is not a split personality.
                    <br />
                    <br />
                    For more information see:{" "}
                    <a href="https://www.betterhealth.vic.gov.au/health/conditionsandtreatments/schizophrenia">
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    Stress response syndromes occur when a person develops
                    emotional or behavioral symptoms in response to a stressful
                    event or situation. The stressors may include natural
                    disasters, such as an earthquake or tornado; events or
                    crises, such as a car accident or the diagnosis of a major
                    illness; or interpersonal problems, such as a divorce, death
                    of a loved one, loss of a job, or a problem with substance
                    abuse. Stress response syndromes usually begin within three
                    months of the event or situation and ends within six months
                    after the stressor stops or is eliminated.
                    <br />
                    <br />
                    For more information see:{" "}
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    Factitious disorders are conditions in which a person
                    knowingly and intentionally creates or complains of physical
                    and/or emotional symptoms in order to place the individual
                    in the role of a patient or a person in need of help.
                    <br />
                    <br />
                    For more information see:{" "}
                    <a href="https://www.google.com/">Factitious disorders</a>
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    These include disorders that affect sexual desire,
                    performance, and behavior. Sexual dysfunction, gender
                    identity disorder, and the paraphilias are examples of
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    A person with a somatic symptom disorder, formerly known as
                    a psychosomatic disorder or somatoform disorder, experiences
                    physical symptoms of an illness or of pain with an excessive
                    and disproportionate level of distress, regardless of
                    whether or not a doctor can find a medical cause for the
                    symptoms.
                    <br />
                    <br />
                    For more information see:{" "}
              ...
              <div className="tab">
                ...
                <div className="tab-content">
                  <p>
                    People with tic disorders make sounds or display
                    nonpurposeful body movements that are repeated, quick,
                    sudden, and/or uncontrollable. (Sounds that are made
                    involuntarily are called vocal tics.) Tourette's syndrome is
                    an example of a tic disorder.
                    <br />
                    <br />
                    For more information see:{" "}
